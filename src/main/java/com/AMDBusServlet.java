...
@WebServlet("/AMDBusServlet")
public class AMDBusServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		rd = getServletContext().getRequestDispatcher("/amdbusdetails.jsp");
